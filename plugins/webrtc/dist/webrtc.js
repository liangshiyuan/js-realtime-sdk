(function (global, factory) {
	...
	function _iterableToArrayLimit(arr, i) {
	  if (typeof symbol$1 === "undefined" || !isIterable$1(Object(arr))) return;
	  var _arr = [];
	  var _n = true;
	  var _d = false;
	  var _e = undefined;
	...
	*/
	...
	function (_EventEmitter) {
	  ...
	  function Call(conversation, RTCConfiguration) {
	    ...
	    _this._promises = {};
	    var streamReady = new promise$1(function (resolve) {
	      _this._promises.resolveStreamReady = resolve;
	    });
	    var accept = new promise$1(function (resolve) {
	      _this._promises.resolveAccept = resolve;
	    });

	    promise$1.all([streamReady, accept]).then(function (_ref) {
	...
	function (_EventEmitter) {
	  ...
	  _proto.call = function call(targetId, stream) {
	    ...
	    return this._imClient.ping([targetId]).then(function (onlineClients) {
	      ...
	      var promise = new promise$1(function (resolve) {
	      ...
	      return promise.then(function () {
	        return promise$1.all([_this3._imClient.createConversation({
	          members: [targetId],
	          unique: true
