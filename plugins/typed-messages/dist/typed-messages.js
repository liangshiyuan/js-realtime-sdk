(function (global, factory) {
	...
	function (_TypedMessage) {
	  inheritsLoose(FileMessage, _TypedMessage);
	  ...
	  function FileMessage(file) {
	    ...
	    _this._lcfile = {
	      objId: file.id,
	      url: file.url(),
	      metaData: assign$1(file.metaData() || {}, {
	        name: file.name()
	      })
	    };
	    return _this;
	...
	/*#__PURE__*/
	function (_TypedMessage) {
	  inheritsLoose(LocationMessage, _TypedMessage);
	  ...
	  _proto.toJSON = function toJSON() {
	    return _objectSpread$1({}, _TypedMessage.prototype.toJSON.call(this), {
